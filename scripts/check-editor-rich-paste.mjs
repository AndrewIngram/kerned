...
for(const [name,type] of Object.entries({chromium,firefox,webkit})){
 ...
 await page.evaluate(id=>window.editorDiagnostics.select(id,7),id);await settle();await page.keyboard.down('Shift');for(let i=0;i<4;i++)await page.keyboard.press('ArrowRight');await page.keyboard.up('Shift');const partial=await copy();

...
export const packageMoves = [
  ...
  { from: 'src/editor-stream.ts', to: 'apps/demo/src/editor-stream.ts' },
  {
    ...
    name: '@kerned/starter-kit',
    public: '@kerned/starter-kit',
  },
  {
    from: 'src/extensions/starter-kit/browser.ts',
    to: 'packages/starter-kit/src/browser.ts',
    name: '@kerned/starter-kit',
    public: '@kerned/starter-kit/browser',
  },
  {
  ...
  },
  {
    ...
    name: '@kerned/extension-editing',
    public: '@kerned/extension-editing',
  },
  {
  ...
  },
  {
    ...
    name: '@kerned/extension-editing',
    public: '@kerned/extension-editing/browser',
  },
  {
  ...
  { from: 'src/editor-browser', to: 'packages/view/src/browser', name: '@kerned/view' },
  { from: 'src/editor-canvas', to: 'packages/view/src/canvas', name: '@kerned/view' },
  { from: 'src/editor-react', to: 'packages/react/src', name: '@kerned/react' },
  ...[
    'engines.ts',
    'layout-types.ts',
    'owned-blocks.ts',
  ...
  { from: 'src/__tests__', to: 'packages/view/src/internal/__tests__', name: '@kerned/view' },
  {
    from: 'src/extensions/comment.ts',
    to: 'packages/extension-comments/src/comment.ts',
    name: '@kerned/extension-comments',
    public: '@kerned/extension-comments',
  },
  {
  ...
  },
  {
    ...
    name: '@kerned/extension-comments',
    public: '@kerned/extension-comments/browser',
  },
  {
  ...
  },
  {
    ...
    name: '@kerned/extension-history',
    public: '@kerned/extension-history',
  },
  {
    from: 'src/extensions/outline.ts',
    to: 'packages/extension-outline/src/index.ts',
    name: '@kerned/extension-outline',
    public: '@kerned/extension-outline',
  },
  {
    from: 'src/extensions/search-view.ts',
    to: 'packages/extension-search/src/index.ts',
    name: '@kerned/extension-search',
    public: '@kerned/extension-search',
  },
  {
  ...
  { from: 'src/extensions/html.ts', to: 'src/demo/import-html.ts' },
  {
    ...
    name: '@kerned/extension-document',
    public: '@kerned/extension-document',
  },
  {
  ...
  },
  {
    ...
    name: '@kerned/extension-table',
    public: '@kerned/extension-table',
  },
  {
  ...
  },
  {
    ...
    name: '@kerned/extension-table',
    public: '@kerned/extension-table/browser',
  },
  {
  ...
  },
  {
    ...
    name: '@kerned/extension-document',
    public: '@kerned/extension-document/browser',
  },
  {

...
try{for(const width of [1100,390]){
 ...
 await page.evaluate(()=>window.editorDiagnostics.select(1,0));await page.keyboard.down('Shift');

for(let i=0;i<5;i++)await page.keyboard.press('ArrowRight');await page.keyboard.up('Shift');

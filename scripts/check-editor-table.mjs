...
for(const [name,type] of Object.entries({chromium,firefox,webkit})){
  ...
  try{
    ...
    const imported=await page.evaluate(()=>window.editorDiagnostics.importHtml('<p>Before</p><table><caption>Example</caption><tr><th colspan="2">Title</th></tr><tr><td rowspan="2"><strong>A</strong></td><td>B</td></tr><tr><td><u>C</u></td></tr></table><p>After</p>'));
    ...
    const bookTable=await page.evaluate(()=>window.editorDiagnostics.read().nodes.find(n=>n.kind==='table'));

...
`hitTestTextLines` from `@kerned/view` accepts text regions in document coordinates.
...
`createTextNavigation` from `@kerned/view` handles arrows, Home/End, Page Up/Down

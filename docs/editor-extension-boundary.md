...
`npm run check:editor-boundaries` rejects imports from the editing core into demo/schema/React/layout code. It also requires the independent extension fixtures to use only the public entry point.

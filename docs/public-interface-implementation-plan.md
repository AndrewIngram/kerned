...
Date: 2026-09-21. Status: implementation in progress. Milestones 0–5 are complete, including independent architecture review and agreed fixes. Milestone 6 is in progress. See [verified progress](public-interface-progress.md)
...
| `view`                     | `editor-browser`, `editor-canvas`, `owned-*`, rendering and viewport logic in hooks                                 | Browser input, geometry, private layout and graphics lifetime             |
...
Content-slot ownership, geometry and verification are detailed in
[Editable content slots](content-slots.md).

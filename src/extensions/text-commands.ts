...
export function textCommands(schema:Schema<StarterNode>,state:EditorState<StarterNode>,tree=indexTree(schema,state.nodes)){
  ...
  return {
    ...
    clear():Step<StarterNode>[]{return changeSelectionMarks(schema,state,{kind:'clear'},tree);},

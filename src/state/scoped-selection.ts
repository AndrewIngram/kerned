import type { NodeIdentity, SelectionRange, TreeIndex } from '../model';
import { RangeSelection, type RangeEndpoint } from './range-selection';
import { TextSelection, type SelectionContext } from './selection';

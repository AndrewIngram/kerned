import type { ReadTextStyle, TextStyle } from '../browser/text-style.js';
import type { createOwnedEngine } from '../internal/owned-layout.js';
import type { createDOMFonts } from './dom-fonts.js';
import type { TextPresentation } from './scene.js';
import type { createTextColors } from './text-colors.js';

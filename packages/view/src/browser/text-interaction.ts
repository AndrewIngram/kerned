...
import { moveNodeSelection, textBoundaryNearNode, type NavigationNode } from './node-navigation.js';
import type { PointerSelectionOptions } from './pointer-selection.js';
import { textSelectionAtClick } from './selection-view.js';

...
import { createEditorEvents, type EditorEvents } from './events.js';
import type { StateFieldRegistration, ExtensionUpdate } from './extension-state.js';
import { createFindSession } from './find.js';
import { createLocalHistory, type HistoryOptions } from './local-history.js';
import {
  assertEditAllowed,
